    ...
    <>
      <div className="pt-32 pb-16 bg-espresso">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <div className="flex items-center gap-3 mb-4"><div className="h-px w-8 bg-copper/60" /><span className="text-xs font-sans uppercase tracking-[0.2em] text-copper/80">All Episodes</span></div>
          <h1 className="font-serif text-4xl lg:text-6xl font-bold text-cream mb-4">Episodes</h1>
          <p className="text-beige/60 text-lg max-w-xl">Conversations about the financial infrastructure, institutions, and policies that shape economic life.</p>
        </div>
      </div>
