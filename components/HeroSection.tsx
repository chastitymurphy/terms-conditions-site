...
export default function HeroSection() {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-warm-dark">
      ...
      />
      {/* Dark overlay */}
      <div className="absolute inset-0 bg-gradient-to-br from-warm-dark via-warm-dark/95 to-espresso/60" />
      {/* Grain */}
      <div
      ...
      {/* Content — single column, matching original layout */}
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-10 pt-28 pb-24">
        <div className="max-w-3xl">
          ...
          <p className="font-serif text-xl lg:text-2xl text-cream/90 italic leading-relaxed mb-4 max-w-2xl">
            Why does it feel like the economy runs on rules nobody explained to us?
          </p>
          <p className="font-sans text-lg text-cream/65 leading-relaxed mb-10 max-w-xl">
          ...
          {/* Host byline with photo */}
          <div className="flex items-center gap-3 mt-10 pt-8 border-t border-white/10">
            <div className="relative w-11 h-11 rounded-full overflow-hidden border-2 border-copper/50 shrink-0">
              <Image
        ...
        {/* Scroll indicator */}
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-cream/20 hidden lg:flex">
